...
ownerID = int("5820956681") #ايدي الادمن 
api_hash = Config.'6cc248d1b0d626232ef66ac5153370b8' #ايبي هاش 
api_id = Config.'28929515' #ايبي ايدي
token = Config.'6771117413:AAHM_0qb4BsAahacl_QIsQ0qwbgBJI65TjE' #البوت


bot = Client(
  'bot'+token.split(":")[0],
  28929515, #ايبي ايدي
 '6cc248d1b0d626232ef66ac5153370b8', #ايبي هاش
